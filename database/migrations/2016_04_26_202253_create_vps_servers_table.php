...
class CreateVpsServersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vps_servers', function (Blueprint $table) {
            ...
            $table->foreign('provider_id')->references('id')->on('server_providers')->onDelete('cascade');
            $table->string('name');
            $table->string('url');
            ...
            $table->integer('bandwith_tb')->unsigned();
